"""v5/build_windows.py 鈥?T+5 label + preprocessing + fixed two-stage normalization.
...
DATA_DIR = r"D:\whz\course\深度学习\LAB\FINAL_LAB\final_lab\documents-export-2026-5-15"
INDEX_PATH = os.path.join(DATA_DIR, "market", "000300.SH.csv")
WINDOWS_DIR = os.path.join(ROOT, "processed", "windows_v5")

T = 60
LABEL_HORIZON = 5  # T+5 cumulative return as label (higher SNR than T+1)
...
def main():
    ...
    # ---- Pass 2: Winsorization 鈫?cross features 鈫?normalize 鈫?save ----
